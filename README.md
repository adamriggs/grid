...
* fillSize: width and height of the grid fill - this can be larger than the grid size
...
* showHeartBeat: tweens x, y coordinates along a path that resembles an ekg monitor
